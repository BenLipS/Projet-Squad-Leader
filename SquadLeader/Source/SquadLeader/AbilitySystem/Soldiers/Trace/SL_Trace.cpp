...
void ASL_Trace::AimWithPlayerController(const AActor* InSourceActor, FCollisionQueryParams Params, const FVector& TraceStart, FVector& OutTraceEnd, bool bIgnorePitch)
{
...
TArray<FHitResult> ASL_Trace::PerformTrace(AActor* InSourceActor)
{
