...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FPlayMontageAndWait);
 ...
 */
UCLASS()
class SQUADLEADER_API UAbilityTask_PlayMontageAndWaitForEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	FPlayMontageAndWait OnCompleted;

	UPROPERTY(BlueprintAssignable)
	FPlayMontageAndWait OnBlendOut;

	UPROPERTY(BlueprintAssignable)
	FPlayMontageAndWait OnInterrupted;

	UPROPERTY(BlueprintAssignable)
	FPlayMontageAndWait OnCancelled;
