...
#include "SL_WaitTargetDataUsingActor.generated.h"
 ...
 */
UCLASS()
class SQUADLEADER_API USL_WaitTargetDataUsingActor : public UAbilityTask
{
	...
	*/
	...
	static USL_WaitTargetDataUsingActor* WaitTargetDataWithReusableActor(
