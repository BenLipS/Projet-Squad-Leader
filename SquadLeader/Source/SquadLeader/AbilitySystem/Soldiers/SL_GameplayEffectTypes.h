...
#include "SL_GameplayEffectTypes.generated.h"
 ...
 */
USTRUCT()
struct SQUADLEADER_API FSL_GameplayEffectContext : public FGameplayEffectContext
{
...
public:
	...
	*/
	...
	{
		return FSL_GameplayEffectContext::StaticStruct();
	}

	virtual FSL_GameplayEffectContext* Duplicate() const override
	{
		FSL_GameplayEffectContext* NewContext = new FSL_GameplayEffectContext();
		*NewContext = *this;
...
template<>
struct TStructOpsTypeTraits<FSL_GameplayEffectContext> : public TStructOpsTypeTraitsBase2<FSL_GameplayEffectContext>
{
	enum
	{
