...
#include "SL_AbilityTypes.generated.h"

class UAbilitySystemSoldier;
class UGameplayEffect;
class USL_TargetType;
...
struct FSL_GameplayEffectContainer
{
	GENERATED_BODY()

public:
	FSL_GameplayEffectContainer() {}

	/** Sets the way that targeting happens */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = GameplayEffectContainer)
	TSubclassOf<USL_TargetType> TargetType;
...
USTRUCT(BlueprintType)
struct FSL_GameplayEffectContainerSpec
{
	GENERATED_BODY()

public:
	FSL_GameplayEffectContainerSpec() {}
